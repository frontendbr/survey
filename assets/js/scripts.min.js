!function(a, b) {
    ...
    m.draw = function() {
        ...
        this.svg.setAttribute("width", a), c;
    }, m.values = function() {
        ...
        for (var d = 0, c = b.length, f = 0; c > d; d++) f += b[d];
        for (var a = this.prepare(a.width || a.diameter, a.height || a.diameter), d = a.width(), g = a.height(), a = d / 2, g = g / 2, p = h.min(a, g), e = h.PI, j = this.fill(), i = -e / 2, d = 0; c > d; d++) {
            var k, n = b[d], l = n / f;
            if (0 != l) {
                if (1 == l) k = o("circle", {
                    cx: a,
        ...
        for (var b = this.values(), c = h.max.apply(h, b.concat([ a.max ])), d = h.min.apply(h, b.concat([ a.min ])), f = this.prepare(a.width, a.height), g = f.width(), f = f.height(), e = c - d, j = 0 == e ? 0 : f / e, a = a.gap, g = (g + a) / b.length, m = this.fill(), i = 0; i < b.length; i++) {
            ...
            0 == k ? (k = r, (0 >= d && c > 0 || 0 == e) && (l -= r)) : 0 > k && (l += k, k = -k), 
            n = o("rect", {
...
}(jQuery, document, Math), function(window, document, $) {
    "use strict";
    var sizeWindow = 0, mediaquery = {
        xxs: 480,
        xs: 767,
        sm: 768,
        md: 992,
        lg: 1200
    }, isTouchDevice = ($('[data-toggle="overlay"]'), "ontouchstart" in document.documentElement);
    window.sizeWindow = function(val) {
        return val ? void (sizeWindow = val) : sizeWindow;
        ...
        isTouchDevice && $(_targetContainer + "," + _target).hammer({
            drag_lock_to_axis: !0
        }).on(_move, function(ev) {
            ev.gesture.preventDefault();
            var me = $(this);
            return me.is(_targetContainer) ? me.carousel(_direction) : me.parents(_targetContainer).carousel(_direction), 
            !1;
        });
    };
    ...
    }), $(".scroller").nanoScroller(), $(".btn-share").click(function() {
        $(".social-list, .social-media").toggleClass("in");
    }), $("input[placeholder], textarea[placeholder]").highlight(), $(window).resize(function() {
        sizeWindow($(window).width()), isMax_XS(), isMin_SM(), isMax_MD(), isMin_LG();
    }), $(window).resize(), swipeTouch(".carousel .item", ".carousel", "prev", "swiperight, dragright"), 
