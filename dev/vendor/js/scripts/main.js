(function(window, document, undefined) {
  ...
  Morris.Donut({
    ...
    data: dataRegions,
    formatter: function (y) { return Math.round(( y / 156) *100 ) + '%' }
  });
  ...
  Morris.Donut({
    ...
    formatter: function (y) { return Math.round(( y / 103) *100 ) + '%' }
  });

  Morris.Donut({
    element: 'chart-levels-sul',
    data: dataLevelsSul,
    formatter: function (y) { return Math.round(( y / 35) *100 ) + '%' }
  });

  Morris.Donut({
    element: 'chart-levels-nordeste',
    data: dataLevelsNordeste,
    formatter: function (y) { return Math.round(( y / 13) *100 ) + '%' }
  });

  Morris.Donut({
    element: 'chart-levels-norte',
    data: dataLevelsNorte,
    formatter: function (y) { return Math.round(( y / 5) *100 ) + '%' }
  });
