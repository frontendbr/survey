...
import ApiMenSpecialist from './salary-men-specialist.json';
...
ChartDoughnut({ api: ApiMenEstag, selector: $selector('[data-chart="men-estag"]'), quantity: 34 });
ChartBar({ api: ApiWomenJr, selector: $selector('[data-chart="women-jr"]'), quantity: 36 });
ChartBar({ api: ApiMenJr, selector: $selector('[data-chart="men-jr"]'), quantity: 218 });
ChartBar({ api: ApiWomenPlann, selector: $selector('[data-chart="women-plann"]'), quantity: 42 });
ChartBar({ api: ApiMenPlann, selector: $selector('[data-chart="men-plann"]'), quantity: 365 });
ChartBar({ api: ApiWomenSenior, selector: $selector('[data-chart="women-senior"]'), quantity: 16 });
ChartBar({ api: ApiMenSenior, selector: $selector('[data-chart="men-senior"]'), quantity: 196 });
